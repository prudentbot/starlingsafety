...
if ( !class_exists( 'CLD_Admin' ) ) {
	...
	class CLD_Admin extends CLD_Library {
		...
		function cld_admin_menu() {
			...
			add_comments_page("Starling Verifications", "Starling Verifications", "manage_options", "starling-verifications", array($this, 'starling_verifications_page'));
		}
		...
		function starling_verifications_page() {
			include(CLD_PATH . 'inc/views/backend/verifications.php');
		}
